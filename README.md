...
1. Two-Class Models <br>
   ...
   b. First_Pitch_Multi_Batter.ipynb: Trains the individual models on each batter above thresholds of at-bats (default: 100) and first pitch hit into play percentage (default: top 300). Evaluates which model is most effective for the validation data. <br>
   c. First_Pitch_Global.ipynb: Trains the same models on a combined dataset of all batters above thresholds of at-bats (default: 100) and first pitch hit into play percentage (default: top 300).<br>
